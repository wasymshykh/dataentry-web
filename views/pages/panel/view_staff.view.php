        ...
        <div class="row">
            <div class="col-12 mb-4">
                <div class="border p-2">
                    <div class="badge badge-primary">Staff <strong>#<?=$staff['staff_id']?></strong></div>
                    ...
                    <dd class="pl-4 pt-2">
                        ...
                        <dl><strong class="mr-2"><i class="fa fa-map-marker mr-2"></i> Origin</strong> <?=$staff['staff_origin']?></dl>
        ...
        <div class="row">
            <div class="col-4 mb-4">
                <div class="border text-center pt-2">
                    ...
                    <p class="text-muted font-weight-light"><small>Present Rank</small></p>
                </div>
            </div>
            <div class="col-4 mb-4">
                <div class="border text-center pt-2">
                    ...
                    <p class="text-muted font-weight-light"><small>Present Grade Level</small></p>
                </div>
            </div>
            <div class="col-4 mb-4">
                <div class="border text-center pt-2">
                    <h6 class="bg-dark d-table mx-auto mb-2 py-2 px-2 text-light" style="font-size: 1.4em;"><i class="fa fa-calendar"></i></h6>
                    <h5 class="mb-0"><?php if($staff['staff_mda_posted']): $age = $s->getAge($staff['staff_mda_posted'], current_date()); echo $age['years']. ' Years ' . $age['months'] . ' Months'; else: echo ''; endif;?></h5>
            ...
            <div class="col-lg-6 mb-4">
                <div class="card p-2">
                    ...
                    <dd class="pl-4 pt-2">
                        ...
                        <dl><strong class="mr-2"><i class="fa fa-circle-o-notch mr-2"></i> Next of Phone No</strong> <?=$staff['staff_next_phone']?></dl>
