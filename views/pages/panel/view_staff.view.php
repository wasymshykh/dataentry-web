        ...
        <div class="row">
            <div class="col-12 mb-4">
                <div class="border p-2">
                    ...
                    <dd class="pl-4 pt-2">
                        ...
                        <dl><strong class="mr-2"><i class="fa fa-map-marker mr-2"></i> State of Origin</strong> <?=$staff['state_name']?></dl>
            ...
            <div class="col-12 mb-4">
                <div class="card p-2">
                    ...
                    <dd class="pl-4 pt-2">
                        <dl><strong class="mr-2"><i class="fa fa-minus-square-o mr-2"></i> LGA</strong> <?=$staff['lga_name']?></dl>
                        <dl><strong class="mr-2"><i class="fa fa-mercury mr-2"></i> Marrital Status</strong> <?=$marritals[$staff['staff_marrital']]?></dl>
        ...
        <div class="row">
            <div class="col-4 mb-4">
                <div class="border text-center pt-2">
                    ...
                    <h5 class="mb-0"><?=$staff['rank_rank']?></h5>
            ...
            <div class="col-4 mb-4">
                <div class="border text-center pt-2">
                    ...
                    <h5 class="mb-0"><?=$staff['rank_grade']?></h5>
